            ...
            <div class="container">
                ...
                style={{alignitems:  "center"}}>
                    <div class="col-lg-12 col-xl-12">
                        <div>
                            <h1 class="theme-h1 text-center" style={{margintop: 0, paddingtop: 1}}>
About Finorator</h1>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row" style={{justifyContent:  "center"}}>
                    <div class="vision-card col-xl-5 col-lg-4">
                        <img alt='' src={require("../assets/static/assets/vision.png")}/>
                    ...
                    <div class="vision-card col-xl-5 col-lg-4">
                        <img alt='' src={require("../assets/static/assets/mission.png")}/>
            ...
            <div class="container">
                ...
                <div class="row mb-5">
                    <div class="col-xl-4 col-lg-4 col-sm-6">
                        <div class="feature-bigcard">
                            <img alt='' src={require("../assets/static/assets/main-feature1.svg").default} />
                            <div class="description">To be a Financially Literate person and increase your knowledge bank gaining financial wisdom</div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-sm-6">
                        <div class="feature-bigcard">
                            <img alt='' src={require("../assets/static/assets/main-feature2.svg").default} />
                    ...
                    <div class="col-xl-4 col-lg-4 col-sm-12">
                        <div class="feature-bigcard">
                            <img alt='' src={require("../assets/static/assets/main-feature3.svg").default} />
                ...
                <div class="row mt-5 pt-5">
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                        ...
                        <img alt='' src={require("../assets/static/assets/side-feature1.svg").default} /> 

                            <div className="title">Zero-cost Doorstep Consultancy</div>
                            <div className="description">Get a no-cost financial advisory and customer support at your doorstep with no hidden or surplus charges on products & services
</div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                        <div class="text-center feature-smallcard">
                            <img alt='' src={require("../assets/static/assets/side-feature2.svg").default} />
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                        <div class="text-center feature-smallcard">
                            <img alt='' src={require("../assets/static/assets/side-feature3.svg").default} />
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                        <div class="text-center feature-smallcard">
                            <img alt='' src={require("../assets/static/assets/side-feature4.svg").default} />
